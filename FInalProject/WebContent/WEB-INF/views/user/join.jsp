				...
				<div class="card-body">
					<form:form action="${root }user/join_pro" method='post' modelAttribute="joinUserBean">
						...
						<div class="form-group">
							...
							<form:input path="user_add2"  class="user_add2 form-control" readonly="readonly" style="width:490px; height:40px; border:1px solid gray; border-radius:10px;"/><br/><br>
							<form:errors path="user_add2" style="color:red"/>
							<br>
						
							
							<form:label path="user_add3" >상세 주소</form:label>
							<form:input path="user_add3"  class="user_add3 form-control" readonly="readonly" style="width:490px; height:40px; border:1px solid gray; border-radius:10px;"/>
