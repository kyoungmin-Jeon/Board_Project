...
public class ContentBean {
	...
	public String toString() {
		return "ContentBean [content_idx=" + content_idx + ", content_subject=" + content_subject + ", content_text="
				+ content_text + ", upload_file=" + upload_file + ", content_file=" + content_file
				+ ", content_writer_idx=" + content_writer_idx + ", content_board_idx=" + content_board_idx
				+ ", content_date=" + content_date + ", content_writer_name=" + content_writer_name + "]";
	}
